    ...
    return Obx(()=> controller.pcontent.value.sId != null? Container(
                ...
                child:  Column(
                  children: [
                    AspectRatio(
                      aspectRatio: 1/1,
                      child: Image.network(HttpsClient.repleaUrl(controller.pcontent.value.pic),fit: BoxFit.cover),
                    ),
                    Container(
                    ...
                    Container(
                      alignment: Alignment.centerLeft,
                      padding: EdgeInsets.only(top: ScreenAdapter.height(20)),
                      child: Text('${controller.pcontent.value.subTitle}',
                        style: TextStyle(
                          color: Colors.black87,
                      ...
                      child:  Row(
                        ...
                        children: [
                          Row(children: [
                              ...
                              Text("￥${controller.pcontent.value.price}", style: TextStyle(color: Colors.red,fontSize: ScreenAdapter.fontSize(86))),
                            ]
                          ),
                          Row(children: [
                              const Text("原价：", style: TextStyle(fontWeight: FontWeight.bold)),
                              Text("￥${controller.pcontent.value.oldPrice}", style: TextStyle(
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.only(top: ScreenAdapter.height(20)),
                      child:  InkWell( // GestureDetector  InkWell
                        onTap: (){
                           showBottomAttr();
                        },
                        child: Row(
                          ...
                          children: [
                            ...
                            Icon(Icons.arrow_forward_ios_outlined,color: Colors.black38,size: ScreenAdapter.fontSize(46))
                          ],
                        ),
                      ),
                    ),
