...
import '../modules/productContent/controllers/product_content_controller.dart';

class CartServices {
  //增加购物车
  static addCart(ProductItemModel pcontent,String selectedAttr, int buyNum) async {
    /*
        1、获取本地存储的cartList数据
        2、判断cartList是否有数据
              有数据：
